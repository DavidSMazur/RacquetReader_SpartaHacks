...
# Define video source
video_path = str(Path('data/video/swing.mp4'))
...
# Variable to track if the first object is detected
...
while cap.isOpened():
    ...
    if success:
        ...
        for result in results:
            ...
            # Check if the first object is detected
            if not first_object_detected:
                # Set first_object_detected to True
                first_object_detected = True

                # Continue with processing the detected object
